...
<script>
 ...
 $(document).ready(function(){ 
     $('#exp_comm_form').on("submit", function(event){  
           ...
           {  
                $.ajax({  
                     url:"exp_comm.php",  
                     method:"POST",  
                     data:$('#exp_comm_form').serialize(),  
                     beforeSend:function(){  
                          $('#insert').val("Comment");  
                     },  
                     success:function(data){  
                          $('#exp_comm_form')[0].reset();    
                          $('#read').html(data);  
                     }  
                });  
           }  
...
<body>
<div id="area">
<form name="exp_comm_form" id="exp_comm_form" method="post">
...
<div id="read">
<?php
 $sel_qry = "SELECT * FROM expenses_comment_table WHERE salesid='$salesid' ORDER BY date DESC";
