...
<script>
 ...
 $(document).ready(function(){ 
     $('#todo_comm_form').on("submit", function(event){  
           ...
           {  
                $.ajax({  
                     url:"tod_comm.php",  
                     method:"POST",  
                     data:$('#todo_comm_form').serialize(),  
                     beforeSend:function(){  
                          $('#insert').val("Comment");  
                     },  
                     success:function(data){  
                          $('#todo_comm_form')[0].reset();    
                          $('#read').html(data);  
                     }  
                });  
           }  
...
<body>
<div id="area">
<form name="todo_comm_form" id="todo_comm_form" method="post">
...
<div id="read">
<?php
 $sel_qry = "SELECT * FROM todos_comment_table WHERE salesid='$salesid' ORDER BY date DESC";
