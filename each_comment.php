...
<script>
 ...
 $(document).ready(function(){ 
     $('#sales_comm_form').on("submit", function(event){  
           ...
           {  
                $.ajax({  
                     url:"each_commenting.php",  
                     method:"POST",  
                     data:$('#sales_comm_form').serialize(),  
                     beforeSend:function(){  
                          $('#insert').val("Comment");  
                     },  
                     success:function(data){  
                          $('#sales_comm_form')[0].reset();    
                          $('#read').html(data);  
                     }  
                });  
           }  
...
<body>
<div id="area">
<form name="sales_comm_form" id="sales_comm_form" method="post">
