...
<head>
    ...
    <title>Receipt - Bootsnipp.com</title>
    			...
    			<div class="receipt-header">
					<div class="col-xs-6 col-sm-6 col-md-6">
						<div class="receipt-left">
							<img class="img-responsive" alt="iamgurdeeposahan" src="img/boldlinks logo.JPG" style="width: 200px; border-radius: 100px;">
						</div>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-6 text-right">
						<div class="receipt-right">
							<h5>BOLDLINKS TECHNOLOGY</h5>
							<p>+2347031259185 <i class="fa fa-phone"></i></p>
							<p>info@boldlinks.com.ng <i class="fa fa-envelope-o"></i></p>
							<p>Nigeria <i class="fa fa-location-arrow"></i></p>
						</div>
					</div>
				</div>
            </div>
            ...
            <div>
                <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <!--  <tr>
                            <td>Olayioye Ibrahim</td>
                        
                        </tr>-->
                        <tr>
                            <td class="col-md-4"><?php //echo $generate_receipt ? $customer['name'] : ''; ?></td>
                            <td class="col-md-5"><?php echo $row['nature_of_job']; ?></td>
...
title="Click to print this page"><button>Print receipt</button></a>
</div>
